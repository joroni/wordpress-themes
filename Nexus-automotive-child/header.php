		...
		<div class="container">
			...
			<div id="top-navigation" class="clearfix">
				...
				<ul id="et-social-icons">
					...
					<li class="tumblr">
						<a href="http://carsboatsandbikes.tumblr.com/">
							<span class="et-social-normal"><?php esc_html_e( 'Follow us on Tumblr', 'Nexus' ); ?></span>
							<span class="et-social-hover"></span>
						</a>
					</li>

					<li class="pinterest">
						<a href="http://pinterest.com/carsboatsbikes/">
