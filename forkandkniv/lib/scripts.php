...
function gs_register_scripts() {
	...
	wp_register_style( 'gs-twitter-bootstrap-cdn', '//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.min.css', array(), '3.0.0' );
	...
	wp_register_script( 'gs-twitter-bootstrap-cdn', '//netdna.bootstrapcdn.com/bootstrap/3.0.0/js/bootstrap.min.js', array( 'jquery' ), '3.0.0' );
...
function gs_enqueue_scripts() {
	...
	// Styles
	wp_enqueue_style( 'gs-twitter-bootstrap-cdn' );
