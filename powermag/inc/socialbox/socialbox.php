...
if(!class_exists('SocialBox') and !class_exists('SocialBoxWidget')){
	...
	class SocialBox{
		...
		public function addAdminNotice(){
			...
			<div id="message" class="updated hidden"><?php /* djwd edit - added hidden class */ ?>
				<p>
		...
		public function registerAdminStyle(){
			...
			wp_enqueue_style (self::SLUG . '-widgets-page', get_template_directory_uri() . '/inc/socialbox/css/widgets-page.css', array(), self::VERSION, 'screen' ); 
