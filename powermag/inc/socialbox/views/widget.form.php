...
<div class="socialbox-options">
	...
	<fieldset class="widefat socialbox-general">
		...
		<p class="hidden"> <?php /*djwd added hidden class*/ ?>
			<!-- Show Buttons -->
	...
	*/
	...
	<?php /* djwd removed GitHub */ ?>
	
	<!-- Additional Settings -->
	<fieldset class="widefat hidden"><?php /*djwd added hidden class*/ ?>
	...
	<!-- Support Note -->
	<fieldset class="widefat socialbox-support hidden"><?php /*djwd added hidden class*/ ?>
