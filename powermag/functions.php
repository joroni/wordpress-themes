...
function powermag_scripts() {
	...
	wp_enqueue_style ( 'jackbox-css', get_template_directory_uri() . '/inc/jackbox/css/jackbox.css', array(), 'all' ); //Jackbox Stylesheet
	...
	function deregister_styles() {
		...
		//Socialbox (front-end) @since PM 1.3.0
		wp_deregister_style( 'socialbox' );
