		...
		<div class="row">
			<div class="navi-class span12 clearfix">
				<nav role="navigation" class="site-navigation main-navigation">
							...
							<div class="date">
								<a href="<?php echo get_day_link('', '', ''); ?>" rel="tooltip" data-original-title="<?php _e('Check out today&#39s posts!', 'powermag')?>" data-placement="left"><?php echo date(get_option('date_format')); ?></a>
