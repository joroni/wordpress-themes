 ...
 * @package Genesis\Widgets
 */
class Custom_Featured_Post extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( have_posts() ) : while ( have_posts() ) : the_post();
			...
			if ( $instance['show_title'] )
				...
				// 	printf( genesis_html5() ? '<p class="entry-meta">%s</p>' : '<p class="byline post-info">%s</p>', strtoupper( do_shortcode( $instance['post_info'] ) ) );
				...
				if ( ! empty( $instance['show_byline'] ) && ! empty( $instance['post_info'] ) ) {
					...
					printf( '<p class="byline post-info post-meta-custom"><span class="meta-bold">BY %s; %s |</span> TAGS: %s</p>', strtoupper( get_the_author() ), strtoupper( get_the_date( 'M j Y' ) ), strtoupper( $taglist ) );
				}
			...
			if ( ! empty( $instance['show_content'] ) ) {
				...
				printf( '<div class="entry-content %s">', ( has_post_thumbnail() ? "content-wrap" : "" ) );
