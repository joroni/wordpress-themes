...
<html class="fullSize">
	...
	<body class="thankYouPage fullSize">
		<div class="fader fullSize">
			<div class="gradient">
				<div class="container fullSize">
					...
					<p>
						<a class="backLink" href="<?php echo home_url()?>/gold"><i class="backImage"></i>Click here to go back to LTSC.com.au</a>
					</p>
				</div>
		...
		<?php include __DIR__ . '/../tracking/thankyou-google.php'; ?>
		<?php include __DIR__ . '/../tracking/thankyou-image-gold.php'; ?>
