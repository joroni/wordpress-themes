<div class="headerWrap">
	<div class="header">
		<a href="<?php echo home_url() ?>" title="LTSC"><img class="logo" alt="LTSC" src="<?php echo get_template_directory_uri() ?>/gold/img/logo.png" /></a>
...
<div class="core">
	...
	<section class="coreSection2 row">
		<div class="coreSection2-text col-2">
			...
			<p>
				Investors can take advantage of this capital gain from as little as $4 per day.
			</p>
				
			<p>
				$4 per day is all that's required to secure your slice of the profits that will be made in the next 10 years.
			</p>
		</div>
		<div class="coreSection2-graph col-2">
			<div class="chartImage invisible">
				<img src="<?php echo get_template_directory_uri() ?>/gold/img/graph.png" />
			</div>
	...
	<section class="coreSection5">
		<div class="leftSide">
			<img alt="LTSC" src="<?php echo get_template_directory_uri() ?>/gold/img/logo.png" />
			<div class="text">
