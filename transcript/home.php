<?php get_header(); ?> 
	<div id="primarytopwrapper">
		...
		<div id="primarysidebar">
			<?php include (TEMPLATEPATH . '/home-sidebar1.php'); ?>
		</div><!-- End of rightColAd -->
		
		<div class="clear"></div>
	</div><!-- End of PrimaryWrapper (Featured block + Mid colum block + 120+600 ad) -->

	<?php include (TEMPLATEPATH . '/home-mediabar.php'); ?>
	
	<?php include (TEMPLATEPATH . '/home-primarybottom.php'); ?>
		
	<div id="secondary-wrapper">
		<?php include (TEMPLATEPATH . '/home-secondarycontent.php'); ?>
		<?php include (TEMPLATEPATH . '/home-sidebar2.php'); ?>
