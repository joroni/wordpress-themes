...
$photo_width = 629;		// Width of photo
$wraper_width = 635;		// Width of wrapper div that surrounds image
...
if ( !empty($attachments) ) :
	...
	foreach ( $attachments as $att_id => $attachment ) {
		...
		# Large photo
		$src = wp_get_attachment_image_src($attachment->ID, 'trns-innerslide', true);
